...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_BLUE_Pin|LED_ORANGE_Pin|LED_RED_Pin|LED_GREEN_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = LED_BLUE_Pin|LED_ORANGE_Pin|LED_RED_Pin|LED_GREEN_Pin;
